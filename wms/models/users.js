...
var db_name = 'PPRfYFMCOfMQvkUKAItJ';                  // 数据库名，从云平台获取
var db_host =  'mongo.duapp.com';      // 数据库地址
var db_port =  '8908';   // 数据库端口
var username = 'M1pvQ49kcPyPBEBCjugznK1s';                 // 用户名（API KEY）
var password = 'jetrcDocDoKduhvDuTwqmbmwyQ37seVR';                 // 密码(Secret KEY)
